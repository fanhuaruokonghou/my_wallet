...
contract TokenERC20 is owned {
    ...
    function balanceOf1(address user) public view returns(uint256 b){
     ...
     * @param _value 转移数额
     */
    function transferFrom(address payable _from, address payable _to, uint256 _value) onlyOwner public returns (bool success) {
